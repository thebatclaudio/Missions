...
/**
 * Created by Simone on 20/07/2016.
 */
public class HttpUtils {
    ...
    public static HttpURLConnection buildConnection(String url, String method, String params, String authorizationHeader) throws IOException {

        Log.i("HTTPUTILS", authorizationHeader);
